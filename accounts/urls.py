...
urlpatterns = [
    ...
    url(r'^project/(?P<id>\d+)/applying', views.applying_to_project, name='project_applying'),
    url(r'^project/(?P<id>\d+)/removefromparticipate', views.applying_to_project, name='removefromparticipate'),
